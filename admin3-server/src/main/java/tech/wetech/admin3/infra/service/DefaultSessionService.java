...
public class DefaultSessionService implements SessionService {
  ...
  public DefaultSessionService(UserCredentialRepository userCredentialRepository, 
  ...
  public UserinfoDTO login(String username, String password) {
    ...
    if (credential.doCredentialMatch(password)) {
      ...
      // 登录成功后，自动升级旧格式密码为 BCrypt
      passwordService.upgradePasswordIfNeeded(credential, password);
