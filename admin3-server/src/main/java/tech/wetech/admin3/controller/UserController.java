...
import tech.wetech.admin3.sys.service.PasswordService;
...
public class UserController {
  ...
  public UserController(OrganizationService organizationService, UserService userService, PasswordService passwordService) {
  ...
  public ResponseEntity<Void> changePassword(@RequestBody @Valid ChangePasswordRequest request) {
    ...
    passwordService.changePassword(userinfo.userId(), request.oldPassword(), request.newPassword());
  ...
  public ResponseEntity<Void> resetPassword(@PathVariable Long userId, @RequestBody @Valid ResetPasswordRequest request) {
    passwordService.resetPassword(userId, request.newPassword());
    return ResponseEntity.ok().build();
  }
  ...
  record ResetPasswordRequest(@NotBlank String newPassword) {
  }
