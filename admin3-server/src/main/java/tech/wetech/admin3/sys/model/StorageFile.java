...
public class StorageFile extends BaseEntity {
  ...
  protected void onCreate() {
    ...
    Object userObj = SessionItemHolder.getItem(Constants.SESSION_CURRENT_USER);
    if (userObj instanceof UserinfoDTO userInfo) {
      createUser = userInfo.username();
    } else if (userObj instanceof MiniappUser miniappUser) {
      createUser = miniappUser.getNickname();
    } else {
      createUser = "system";
    }
  }
